...
The current development branch validates the manual-memory MVP against OpenCode 1.18.18. Automatic-memory lifecycle behavior remains unreleased until its acceptance suite passes.
